...
var hashPassword_1 = require("../../lib/hashPassword");
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstName, lastName, email, password, token, _b, _c, error_1;
    var _d;
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                _c = (_b = AuthService).registerUser;
                _d = {
                    firstName: firstName,
                    lastName: lastName,
                    email: email
            ...
            case 3:
                ...
                res
                    .status(500)
                    .json({
                    error: error_1.message || "Error occurred while registering user",
                });
                return [3 /*break*/, 4];

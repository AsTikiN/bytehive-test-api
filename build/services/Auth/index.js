...
var registerUser = function (userData) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserService.getUserByQuery({ email: userData.email })];
            case 1:
                user = _a.sent();
                if (user)
            ...
            case 2:
                user = _a.sent();
                token = (0, tokens_1.generateToken)({ id: user.id }, "30d");
...
var loginUser = function (email, password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, UserService.getUserByQuery({ email: email })];
            case 1:
                user = _a.sent();
                if (!user)
